...
<script type="text/javascript">
	...
	function fqBrand(id){
		if(''!=price){
			window.location.href="/Search?brandId="+id +"&keyword=" + keyword + "&price=" + price;
		}else{
			window.location.href="/Search?brandId="+id +"&keyword=" + keyword;
		}
	}
	//点击价格,id为价格区间
	function fqPrice(id){
		if(''!=brandId){
			window.location.href="/Search?price=" + id + "&keyword=" + keyword + "&brandId=" + brandId;
		}else{
			window.location.href="/Search?price=" + id + "&keyword=" + keyword ;
		}
	}
</script>
</head>
