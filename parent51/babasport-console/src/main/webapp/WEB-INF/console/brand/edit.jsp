			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="radio" name="isDisplay" value="1" <c:if test="${brand.isDisplay==1 }">checked</c:if>/>可用
						<input type="radio" name="isDisplay" value="0" <c:if test="${brand.isDisplay==0 }">checked</c:if>/>不可用
					</td>
				</tr>
			</tbody>
			<tbody>
