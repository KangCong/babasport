...
<script type="text/javascript">
	...
	function optDelete(pageNo,bname,isDisplay){
		...
		$("#jvform").attr("action","/brand/deletes.do?pageNo="+pageNo+"&bname="+bname+"&isDisplay="+isDisplay);
		$("#jvform").submit();
...
品牌名称: <input type="text" name="bname" value="${bname}"/>
	...
	<tbody class="pn-ltbody">
		<c:forEach items="${pagination.list }" var="brand">
			<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
				...
				<td align="center">
				<a class="pn-opt" href="/brand/toEdit.do?id=${brand.id }&bname=${bname}&pageNo=${pagination.pageNo}&isDisplay=${isDisplay}">修改</a> | <a class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}" href="#">删除</a>
				</td>
			</tr>
		</c:forEach>
...
<div style="margin-top:15px;"><input class="del-button" type="button" value="删除" onclick="optDelete('${pagination.pageNo}','${bname }','${isDisplay }');"/></div>
</div>
</body>
</html>